    ...
    * {box-sizing: border-box;}
    ...
    with col2:
       components.html("""
                    <html>
                    <body>
                    <h1 style="font-family:Google Sans; font-size:60px"> About Phonepe </h1>
    ...
    with col3:
        components.html("""
                    <html><body"><h1 style="font-family:Google Sans; font-size:60px"> Founder and CEO </h1></body></html>""",)
        st.image("f1.jpg")
    with col4:
        components.html("""
...
#Transaction
    if type=="TRANSACTION":  
       ...
       #Getting the user Input
        ...
        if year=='2024':
            quarter=st.sidebar.selectbox(":violet[Quarter]",("1"))      
        else:
             quarter=st.sidebar.selectbox(":violet[Quarter]",("1","2","3","4")) 
        
        hide_streamlit_style = """ <html> <body> <h1 style="font-family:Google Sans; font-size:50px"> TRANSACTION </h1></body></html> """
...
#Insurance
     ...
     #Getting the user input  .................
        ...
        year = st.sidebar.selectbox(':violet[YEAR]', Year,key='year',index=default_y)
        if year=='2020':
            quarter=st.sidebar.selectbox(":violet[QUARTER]",("2","3","4"))
        elif year=='2024':
             quarter=st.sidebar.selectbox(":violet[QUARTER]",("1"))   
        else:
             quarter=st.sidebar.selectbox(":violet[QUARTER]",("1","2","3","4")) 
...
if SELECT == "About Project":
    ...
    with col2:
         components.html("""
                    <html> <body>
                    <h1 style="font-family:Google Sans; color:blue;font-size:50px"> About this Project </h1>
                    <p style="font-family:Google Sans; font-size:25px">
                        ...
                        <b>Dataset: </b> <a href="https://github.com/PhonePe/pulse#readme">Link</a> <br>
